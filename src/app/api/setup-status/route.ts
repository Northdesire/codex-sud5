...
export async function GET() {
  try {
    ...
    const [leistungenCount, materialCount, angeboteCount, kalkRegeln, firma] =
      await Promise.all([
        ...
        prisma.firma.findUnique({ where: { id: firmaId }, select: { firmenname: true, strasse: true, iban: true } }),
      ]);
